...
const contactInfo = [
  {
    icon: MapPin,
    label: "Location",
    value: "Maitrinagar-2, Kritipur, Kathmandu, Nepal",
    href: null,
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+977-9766832875",
  ...
  },
  {
    icon: Mail,
    label: "Email",
    value: "asimkhanal2024@gmail.com",
    href: "mailto:asimkhanal2024@gmail.com",
  },
  {
    icon: Linkedin,
          ...
          <div className="lg:col-span-2 order-1 lg:order-2">
            ...
            <div className="mt-8 p-6 glass rounded-3xl">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="font-semibold text-foreground">Based in Kritipur, Kathmandu</span>
              </div>
